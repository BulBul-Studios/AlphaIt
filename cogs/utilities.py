...
class utilities(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name="__Moderation Commands:__", value="Commands that you can use for moderation")
        ...
        embed = discord.Embed(color=discord.Color.green())
        embed.set_author(name="Alphait V2.5.6 Commands")
        embed.add_field(name="__Fun and Intercation Commands:__", value="Lists the fun and intercation commands of the bot.")
